...
QT_MOC_LITERAL(4, 30, 13) // "slotReadyRead"

    },
    "Socket\0signalReadyRead\0\0index\0"
    "slotReadyRead"
};
...
void Socket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Socket::signalReadyRead)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Socket::signalReadyRead(int _t1)
{
